...
sed -i 's/cluster.broadcast.method.jgroups.configuration=jgroups-udp.xml/cluster.broadcast.method.jgroups.configuration=/opt/hybris/jgroups/jgroups-tcp.xml/g' /opt/hybris/bin/platform/project.properties
